const hctColumns = [
    ...
    {data: metaLabel["description"], title: "<abbr title='Internally known as `serving_revised`'>Description</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Basic info" },
    ...
    //{data: "meter_level", title: "Level", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "" },
    {data: metaLabel["main_meter"], title: "<abbr title='Marked as building_level_meter'>Main</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Basic info" },
    //{data: "meter_location", title: "Meter location", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "" },
    {data: metaLabel["units"], title: "<abbr title='Measured units'>Units</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Advanced info" },
    //{data: "tenant", title: "Tenant", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "" },
    //{data: "tenant_name", title: "Tenant Name", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "" },
    {data: metaLabel["invoiced"], title: "Invoiced", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Advanced info" },

    {data: metaLabel["building_id"], title: "Building ID", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Advanced info" },
    //{data: "meter_id", title: "<abbr title='Raw meter ID, might contain slashes/hiphens'>Meter ID</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "" },
    //{data: "unit_conversion_factor", title: "<abbr title='Unit conversion factor'>Conv.</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "" },
    //{data: "units_after_conversion", title: "<abbr title='Units after conversion'>C. Units</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "" },
    {data: metaLabel["resolution"], title: "Resolution", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Advanced info" },
    //{data: "adjustment_factor", title: "Adj. Factor", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "" },

    {data: metaLabel["HC_count"], title: "<abbr title='Total count of data points'>Data Points</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "General analysis" },
    ...
    {data: metaLabel["HC_zeroes"], title: "<abbr title='Total count of zeroes'>Zeroes</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "General analysis" },
    ...
    {data: metaLabel["HC_diff_neg"], title: "<abbr title='How many data points are declining (lower than the previous one)'>Diff: Neg.</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Point diff. analysis" },
    {data: metaLabel["HC_diff_neg_perc"], title: "<abbr title='Percentage of declining data points'>D.Neg. (perc)</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Point diff. analysis" },
    {data: metaLabel["HC_diff_pos"], title: "<abbr title='How many data points are increasing (higher than the previous one)'>Diff: Pos.</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Point diff. analysis" },
    {data: metaLabel["HC_diff_pos_perc"], title: "<abbr title='Percentage of increasing data points'>D.Pos. (perc)</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Point diff. analysis" },
    {data: metaLabel["HC_diff_zero"], title: "<abbr title='How many data points are the same as the previous one (no change)'>Diff: Zero</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Point diff. analysis" },
    {data: metaLabel["HC_diff_zero_perc"], title: "<abbr title='Percentage of non-changing data points'>D. Zero (perc)</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Point diff. analysis" },
    ...
    {data: metaLabel["HC_mode"], title: "<abbr title='The mode reading (converted to rate), i.e., most frequent value'>Mode</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Basic analysis" },
    {data: metaLabel["HC_std"], title: "<abbr title='Standard deviation (converted to rate)'>STD</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Basic analysis" },
    // {data: "HC_min", title: "<abbr title='Min reading (converted to rate)'>Min</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Basic analysis" },
    // {data: "HC_max", title: "<abbr title='Max reading (converted to rate)'>Max</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Basic analysis" },
    ...
    {data: metaLabel["HC_outliers"], title: "<abbr title='Counts of outliers - defined as values 5 times higher than the average reading'>Outliers</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Outlier analysis" },
    ...
    {data: metaLabel["HC_outliers_ignz"], title: "<abbr title='Counts of outliers but ignore all zero values'>Outliers ign 0s</abbr>", defaultContent: '', filterType: 'text', visible: false, toggleGroup: "Outlier analysis" },
    ...
    {data: metaLabel["HC_count_score"], title: "<abbr title='Score based on how many data points are available, from 0 for no data points to 5 for 100% availability'>Count score</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Score calculation" },
    {data: metaLabel["HC_zeroes_score"], title: "<abbr title='Score based on how many data points are zero, from 0 for all zeroes to 5 for no zeroes'>Zero score</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Score calculation" },
    {data: metaLabel["HC_diff_pos_score"], title: "<abbr title='Score based on how many data points are incremental, from 0 for all are incremental to 5 for none'>Diff pos score</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Score calculation" },
    {data: metaLabel["HC_functional_matrix"], title: "<abbr title='Functional matrix value - multiplying count score and zero score'>Func matrix</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Score calculation" },
    // {data: "HC_cumulative_matrix", title: "<abbr title='Cumulative matrix value (only for cumulative meters) - multiplying count score, zero score, and diff pos score'>Cumu. matrix</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Score calculation" },
    {data: metaLabel["HC_score"], title: "<abbr title='Score from 0 (no or almost no useful data) to 5 (healthy meter)'>Score</abbr>", defaultContent: '', filterType: 'multi-select', visible: false, toggleGroup: "Score calculation" },
